...
Public Class FrmStockGrid
    ...
    Private Sub dgvstock_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvStock.CellContentClick
        ...
        If i > -1 Then
            Dim id As String = CStr(dgvStock.Rows(i).Cells(0).Value)
            FrmStockUpdate.selectedId = id
            FrmStockUpdate.ShowDialog(Me)
            BindData()
        End If
    End Sub

    Private Sub btnstock_Click(sender As Object, e As EventArgs) Handles btnStock.Click
        FrmStockAdd.txtSupIDStk.Text = supplierID
        FrmStockAdd.ShowDialog()
